...
void loop() {
  ...
  // Sine wave movement with feedforward terms (targets)
  // odrive.setPosition(
  //   sin(phase), // position
  //   cos(phase) * (TWO_PI / SINE_PERIOD), // velocity feedforward (optional)
  //   torque // torque feedforward (optional)
  // );

  // Sine wave movement with limit terms
  odrive.setPositionLimit(
    sin(phase),  // position
    5,           // velocity limit, rev/s (optional)
    torque       // torque limit (optional)
  );
