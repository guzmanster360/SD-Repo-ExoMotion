...
public:
    ...
    /**
     * @brief Sets the control mode to torque.
     */
     void setControlModeTorque();

     /**
     * @brief Sets the control mode to position.
     */
    ...
    /**
     * @brief Sends a new position setpoint with a velocity limit.
     */
    void setPositionLimit(float position, float velocity_limit);

    /**
     * @brief Sends a new position setpoint with velocity and torque limits.
     */
    void setPositionLimit(float position, float velocity_limit, float torque_limit);
